...
function HeroSection() {
  ...
  return (
    <section id="home" className="relative flex items-center justify-start overflow-hidden" style={{ height: 'clamp(100vh, 1750px, 1750px)', paddingTop: 'calc(var(--spacing-3xl) + var(--spacing-md))' }}>
