  ...
  return (
    ...
    >
      <div className="responsive-container" style={{ padding: 'var(--spacing-lg)' }}>
        ...
        <div className="flex justify-center" style={{ marginBottom: 'var(--spacing-2xl)' }}>
          <div className="relative overflow-hidden rounded-2xl shadow-xl bg-gray-100 w-full max-w-md" style={{ minHeight: '400px' }}>
            {/* Map Overlay */}
